...
const handleSubmit = async (e) => {
  ...
  var quoteInfo = {
    ...
    additional: {
      ...
      prevCarrier: $("#prevCarrier").val(),
      continuousCoverage: $("#continuousCoverage").val(),
      policyExp: $("#policyExp").val(),
      claimsIn3Yr: $("#claimsIn3Yr").val(),
      ticketsIn3Yr: $("#ticketsIn3Yr").val(),
      coverageDesired: $("#coverageDesired").val(),
